...
function ajoutBien($pdo,$description,$idtype,$prix,$ville,$superficie,$nbpieces,$jardin){
    $insert = $pdo->prepare("INSERT INTO biens VALUES(null,:description,:idtype,:prix,:ville,:superficie,:nbpieces,:jardin)");
